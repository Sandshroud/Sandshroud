...
bool Sphere::culledBy(
    ...
    const g3d_uint32			inMask,
    g3d_uint32&					outMask) const {
...
bool Sphere::culledBy(
    ...
    int                 numPlanes,
	int&				cullingPlane,
	const g3d_uint32		_inMask) const {
