...
public:
    void GossipHello(Object* pObject, Player* plr, bool AutoSend)
    {
        ...
        Menu->AddItem(0, "Lexicon of Power"         , 15);
        Menu->SendTo(plr);
    }
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char* Code)
    {
        ...
        case 12:    // Barber
            Plr->Gossip_SendPOI(1784.78f, -4205.14f, 7, 6, 0, "Orgrimmar Barber");
            SendEmptyMenu(13889);
            break;
        ...
        case 13:    // A class trainer
            {
                ...
                Menu->AddItem(0, "Warlock"      , 20);
                Menu->AddItem(0, "Warrior"      , 21);
        ...
        case 31: //Inscription
            Plr->Gossip_SendPOI(1839.30f, -4469.69f, 7, 6, 0, "Jo'mah Building");
            SendQuickMenu(13888);
            break;
        ...
        case 33: //Mining
            Plr->Gossip_SendPOI(2029.79f, -4704.1f, 7, 6, 0, "Red Canyon Mining");
            SendQuickMenu(2515);
            break;
