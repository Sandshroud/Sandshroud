...
enum Opcodes
{
    ...
    SMSG_BINDPOINTUPDATE                        = 0x155, // 341, 41557
    ...
    SMSG_LFD_PLAYER_LOCK_INFO_RESPONSE          = 0x36F,    // SMSG uint8, for(uint8) { uint32, uint8, uint32, uint32, uint32, uint32, uint8, for(uint8) {uint32,uint32, uint32}}, uint32, for(uint32) {uint32,uint32}
    CMSG_LFG_TELEPORT                           = 0x370,    // CMSG LFGTeleport
    CMSG_LFD_PARTY_LOCK_INFO_REQUEST            = 0x371,    // CMSG RequestLFDPartyLockInfo
    SMSG_LFD_PARTY_LOCK_INFO_UPDATE             = 0x372,    // SMSG uint8, for(uint8) uint64
