...
void Player::_AddLanguages(bool All)
{
    ...
    SkillLineEntry * en;
    uint32 spell_id;
    static uint32 skills[] = { SKILL_LANG_COMMON, SKILL_LANG_ORCISH, SKILL_LANG_DWARVEN, SKILL_LANG_DARNASSIAN, SKILL_LANG_GUTTERSPEAK, SKILL_LANG_TAURAHE,
         SKILL_LANG_GNOMISH, SKILL_LANG_TROLL, SKILL_LANG_GOBLIN, SKILL_LANG_THALASSIAN, SKILL_LANG_DRAENEI, SKILL_LANG_GILNEAN, 0 };
