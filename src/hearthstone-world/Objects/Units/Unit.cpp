                ...
                if( IsPlayer() )
                {
                    ...
                    if(CastingSpell)
                    {
                        ...
                        case 25228:
                            {
                                ...
                                if( new_caster != NULL && new_caster->isAlive() )
                                {
                                    ...
                                    Spell* spell(new Spell( new_caster, spellInfo, true, NULLAURA ));
                        ...
                        case 28682:
                            {
                                ...
                                if( flag2 & PROC_ON_SPELL_CRIT_HIT )
                                {
                                    ...
                                    {
                                        m_AuraInterface.RemoveAllAurasByNameHash( SPELL_HASH_COMBUSTION, false );
                                    }continue;
                                }
                            }break;
                        ...
                        case 16198: // Improved Water Shield
                            {
                                ...
                                Aura* shield = m_AuraInterface.FindPositiveAuraByNameHash(SPELL_HASH_WATER_SHIELD);
                                if(!shield)
                                    continue;
                        ...
                        case 51527: // Static Shock
                            {
                                Aura* shield = m_AuraInterface.FindPositiveAuraByNameHash(SPELL_HASH_LIGHTNING_SHIELD);
                                if(shield == NULL)
                                    continue;
                        ...
                        case 61840:
                            {
                                ...
                                dmg_overwrite = float2int32(float(dmg)*0.0375f);
                            }break;
                        ...
                        case 40459:
                            {
                                if((CastingSpell->NameHash != SPELL_HASH_MORTAL_STRIKE
                                    ...
                                    || CastingSpell->NameHash != SPELL_HASH_SHIELD_SLAM))
                                    continue;
                            }break;
                        ...
                        case 40452: //Mangle has a 40% chance to grant 140 Strength for 8 sec
                            {
                                if(CastingSpell->NameHash != SPELL_HASH_MANGLE__BEAR_
                                    || CastingSpell->NameHash != SPELL_HASH_MANGLE__CAT_)
                                    continue;
                            }break;
                        ...
                        case 43738://primal instinct
                            {
                                if( CastingSpell->NameHash != SPELL_HASH_MANGLE__CAT_
                                    && CastingSpell->NameHash != SPELL_HASH_MANGLE__BEAR_ )
                                    continue;
                            }break;
                        ...
                        case 16870:
                            {
                                if(!(CastingSpell->c_is_flags & SPELL_FLAG_IS_HEALING
                                    || CastingSpell->c_is_flags & SPELL_FLAG_IS_DAMAGING) )
                                    continue;
                            }break;
                        ...
                        case 57669:
                            {
                                if( CastingSpell->NameHash != SPELL_HASH_EXPLOSIVE_SHOT
                                    && CastingSpell->NameHash != SPELL_HASH_ARCANE_SHOT
                                    && CastingSpell->NameHash != SPELL_HASH_STEADY_SHOT )
                                    continue;
                    ...
                    switch( spellId) // Independent of Casting spell
                    {
                        case 25997:
                            {
                                if(CastingSpell == NULL)
                    ...
                    case 54648:
                        {
                            Aura* aur = m_AuraInterface.FindAura(54646);
                            if( aur )
                            {
                    ...
                    case 33619:
                        {
                            ...
                            uint32 power_word_id = m_AuraInterface.GetAuraSpellIDWithNameHash( SPELL_HASH_POWER_WORD__SHIELD );
                            if( !power_word_id )
                                continue;//this should not ocur unless we made a fuckup somewhere
...
int32 Unit::GetSpellBonusDamage(Unit* pVictim, SpellEntry *spellInfo,int32 base_dmg, bool healing)
{
    ...
    if(res)
        res *= CalculateLevelPenalty(spellInfo);
    return res;
}
