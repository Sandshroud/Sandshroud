...
enum ShapeshiftForm
{
    ...
    FORM_GHOUL              = 7,    //128
    FORM_DIREBEAR           = 8,    //256
    FORM_STEVES_GHOUL       = 9,    //512
    FORM_THARONJA_SKELETON  = 10,   //1024
    FORM_TEST_OF_STRENGTH   = 11,   //2048
    FORM_BLB_PLAYER         = 12,   //4096
    FORM_SHADOW_DANCE       = 13,   //8192
    ...
    FORM_TEST               = 20,   //1048576
    FORM_ZOMBIE             = 21,   //2097152
    FORM_METAMORPHOSIS      = 22,   //4194304
    FORM_DEMON              = 23,   //8388608
    FORM_24                 = 24,   //16777216
