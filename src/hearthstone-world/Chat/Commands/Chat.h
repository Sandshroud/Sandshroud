...
protected:
    ...
    bool HandleDBItemSetClassCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetSubClassCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetNameCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetDisplayIdCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetQualityCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetFlagsCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetBuyPriceCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetSellPriceCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetInventoryTypeCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetAllowableClassCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetAllowableRaceCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetItemLevelCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRequiredLevelCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRequiredSkillCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRequiredSkillRankCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRequiredSpellCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRequiredRank1Command(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRequiredRank2Command(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRequiredFactionCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRequiredFactionStandingCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetUniqueCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetMaxCountCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetContainerSlotsCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetStatTypeCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetStatValueCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetScalingStatIDCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetScalingStatFlagsCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetDamageMinCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetDamageMaxCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetDamageTypeCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetArmorCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetResistanceCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetDelayCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetAmmoTypeCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRangeCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetSpellInfoCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetBondingCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetDescriptionCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetPageIDCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetPageLanguageCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetPageMaterialCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetQuestIDCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetLockIDCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetSheathIDCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRandomPropertyIDCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRandomSuffixIDCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetBlockCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetItemSetCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetMaxDurabilityCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetZoneNameIDCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetMapIdCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetBagFamilyCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetTotemCategoryCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetSocketInfoCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetSocketBonusCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetGemPropertiesCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetRequiredDisenchantSkillCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetLootGoldCommand(const char* args, WorldSession* m_session);
    bool HandleDBItemSetArmorDamageModifierCommand(const char* args, WorldSession* m_session);
